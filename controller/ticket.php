...
switch ($_GET["op"]) {
    ...
    case "insert":
        $datos = $ticket->insert_ticket($_POST["usu_id"], $_POST["emp_id"], $_POST["cat_id"], $_POST["cats_id"], $_POST["tick_titulo"], $_POST["tick_descrip"], $_POST["prio_id"]);
...
<?php
    ...
    case "totalcerrado";
        ...
        break;
        /* TODO: Total de ticket Pendientes soporte 1 (Paula Londoño) para vista de soporte */
    case "soporte1";
        $datos = $ticket->get_ticket_pendiente_soporte1();
        if (is_array($datos) == true and count($datos) > 0) {
            foreach ($datos as $row) {
                $output["TOTAL"] = $row["TOTAL"];
            }
        ...
        /* TODO: Total de ticket Pendientes soporte 2 (Oto Pedroza) para vista de soporte */
    case "soporte2";
        $datos = $ticket->get_ticket_pendiente_soporte2();
        if (is_array($datos) == true and count($datos) > 0) {
            foreach ($datos as $row) {
                $output["TOTAL"] = $row["TOTAL"];
            }
        ...
        /* TODO: Total de ticket Pendientes soporte 3 (Miguel Muñoz) para vista de soporte */
    case "soporte3";
        $datos = $ticket->get_ticket_pendiente_soporte3();
        if (is_array($datos) == true and count($datos) > 0) {
            foreach ($datos as $row) {
                $output["TOTAL"] = $row["TOTAL"];
            }
        ...
        /* TODO: Total de ticket Pendientes soporte 4 (Hector Gomez) para vista de soporte */
    case "soporte4";
        $datos = $ticket->get_ticket_pendiente_soporte4();
        if (is_array($datos) == true and count($datos) > 0) {
            foreach ($datos as $row) {
                $output["TOTAL"] = $row["TOTAL"];
            }
        ...
        /* TODO: Total de ticket Pendientes soporte 5 (Carlos Guzman) para vista de soporte */
    case "soporte5";
        $datos = $ticket->get_ticket_pendiente_soporte5();
        if (is_array($datos) == true and count($datos) > 0) {
            foreach ($datos as $row) {
                $output["TOTAL"] = $row["TOTAL"];
            }
        ...
        /* TODO: Total de ticket Pendientes soporte 6 (Javier Prada) para vista de soporte */
    case "soporte6";
        $datos = $ticket->get_ticket_pendiente_soporte6();
        if (is_array($datos) == true and count($datos) > 0) {
            foreach ($datos as $row) {
                $output["TOTAL"] = $row["TOTAL"];
            }
