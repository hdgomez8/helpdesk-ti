...
class Ticket extends Conectar
{
    ...
    public function insert_ticket($usu_id,$emp_id, $cat_id, $cats_id, $tick_titulo, $tick_descrip, $prio_id)
    {
        ...
        parent::set_names();
        $sql = "INSERT INTO tm_ticket (tick_id,usu_id,emp_id,cat_id,cats_id,tick_titulo,tick_descrip,tick_estado,fech_crea,usu_asig,fech_asig,prio_id,est) VALUES (NULL,?,?,?,?,?,?,'Abierto',now(),NULL,NULL,?,'1');";
    ...
    public function filtrar_ticket($tick_titulo, $cat_id, $prio_id)
    {
        ...
        $sql = "SELECT
            ...
            AND tm_ticket.prio_id = IFNULL(null,tm_ticket.prio_id)
                ";
        $sql = $conectar->prepare($sql);
